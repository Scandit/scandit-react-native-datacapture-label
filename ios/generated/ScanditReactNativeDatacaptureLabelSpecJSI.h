...
#pragma mark - NativeScanditDataCaptureLabelScanditEventPayload

template <typename P0, typename P1, typename P2, typename P3>
struct NativeScanditDataCaptureLabelScanditEventPayload {
  P0 name;
  P1 data;
  P2 viewId;
  P3 modeId;
  bool operator==(const NativeScanditDataCaptureLabelScanditEventPayload &other) const {
    return name == other.name && data == other.data && viewId == other.viewId && modeId == other.modeId;
  }
};

template <typename T>
struct NativeScanditDataCaptureLabelScanditEventPayloadBridging {
  static T types;
...
class JSI_EXPORT NativeScanditDataCaptureLabelCxxSpecJSI : public TurboModule {
protected:
  NativeScanditDataCaptureLabelCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);

public:
  virtual jsi::Object getConstants(jsi::Runtime &rt) = 0;
  virtual jsi::Value executeLabel(jsi::Runtime &rt, jsi::Object data) = 0;

};

template <typename T>
class JSI_EXPORT NativeScanditDataCaptureLabelCxxSpec : public TurboModule {
public:
  ...
  static constexpr std::string_view kModuleName = "ScanditDataCaptureLabel";

protected:
  NativeScanditDataCaptureLabelCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeScanditDataCaptureLabelCxxSpec::kModuleName}, jsInvoker),
...
private:
  class Delegate : public NativeScanditDataCaptureLabelCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeScanditDataCaptureLabelCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
    ...
    jsi::Value executeLabel(jsi::Runtime &rt, jsi::Object data) override {
      static_assert(
          bridging::getParameterCount(&T::executeLabel) == 2,
          "Expected executeLabel(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::executeLabel, jsInvoker_, instance_, std::move(data));
    }

  private:
    friend class NativeScanditDataCaptureLabelCxxSpec;
    T *instance_;
  };
