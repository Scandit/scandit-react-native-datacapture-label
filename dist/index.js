import { nameForSerialization, serializationDefault, DefaultSerializeable, ignoreFromSerialization } from 'scandit-react-native-datacapture-core/dist/core';
import { NativeModules, NativeEventEmitter } from 'react-native';
import { Barcode } from 'scandit-react-native-datacapture-barcode';
import { CameraSettings, Color, NoViewfinder, Quadrilateral, Brush, Anchor, PointWithUnit } from 'scandit-react-native-datacapture-core';
import { nameForSerialization as nameForSerialization$1, DefaultSerializeable as DefaultSerializeable$1 } from 'scandit-react-native-datacapture-core/js/private/Serializeable';
...
const EventEmitter$2 = new NativeEventEmitter(NativeModule$3);
...
class LabelCaptureBasicOverlayProxy {
    ...
    setBrushForFieldOfLabel(brush, field, label) {
        return NativeModule$1.setBrushForFieldOfLabel(JSON.stringify(brush.toJSON()), label.frameSequenceID, field.name, label.trackingID);
    }
    setBrushForLabel(brush, label) {
        return NativeModule$1.setBrushForLabel(JSON.stringify(brush.toJSON()), label.frameSequenceID, label.trackingID);
    }
    subscribeListener() {
    ...
    unsubscribeListener() {
        NativeModule$1.unregisterListenerForBasicOverlayEvents();
        this.nativeListeners.forEach(listener => listener.remove());
        this.nativeListeners = [];
    }
}
...
class LabelCaptureAdvancedOverlayProxy {
    ...
    nativeListeners = [];
    static forOverlay(overlay) {
        const proxy = new LabelCaptureAdvancedOverlayProxy();
        proxy.overlay = overlay;
        return proxy;
    }
...
class LabelCaptureSettings extends DefaultSerializeable {
    ...
    static settingsFromLabelDefinitions(definitions, properties) {
        ...
        if (properties) {
            settings._hiddenPropertiesJSON = JSON.stringify(properties);
        }
        return settings;
    }
    constructor() {
...
__decorate([
    nameForSerialization$1('labels')
], LabelCaptureSettings.prototype, "_definitions", void 0);
__decorate([
    nameForSerialization$1('hidden_properties_json')
], LabelCaptureSettings.prototype, "_hiddenPropertiesJSON", void 0);
...
class LabelDefinition extends DefaultSerializeable {
    ...
    get hiddenProperties() {
        return JSON.parse(this._hiddenPropertiesJSON);
    }
    set hiddenProperties(newValue) {
        this._hiddenPropertiesJSON = JSON.stringify(newValue);
    }
    static fromJSON(json) {
        const definition = new LabelDefinition(json.name);
        definition._fields = json.fields;
        definition._hiddenPropertiesJSON = json.hidden_properties;
        return definition;
    }
    constructor(name) {
        super();
...
__decorate([
    nameForSerialization$1('name')
], LabelDefinition.prototype, "_name", void 0);
__decorate([
    nameForSerialization$1('fields')
], LabelDefinition.prototype, "_fields", void 0);
__decorate([
    nameForSerialization$1('hidden_properties')
], LabelDefinition.prototype, "_hiddenPropertiesJSON", void 0);
...
class LabelFieldDefinition extends DefaultSerializeable {
    ...
    static fromJSON(json) {
        const definition = new LabelFieldDefinition(json.name);
        definition._name = json.name;
        definition._optional = json.optional;
        definition._patterns = json.patterns;
        definition._hiddenPropertiesJSON = json.hidden_properties;
        return definition;
    }
    constructor(name) {
...
__decorate([
    nameForSerialization$1('optional')
], LabelFieldDefinition.prototype, "_optional", void 0);
__decorate([
    nameForSerialization$1('patterns')
], LabelFieldDefinition.prototype, "_patterns", void 0);
__decorate([
    nameForSerialization$1('hidden_properties')
], LabelFieldDefinition.prototype, "_hiddenPropertiesJSON", void 0);
...
class LabelFieldLocation extends DefaultSerializeable$1 {
    _rect = null;
    _type = null;
    static forRect(rect) {
...
class CustomBarcode extends BarcodeField {
    _dataTypePatterns = [];
    _location = new LabelFieldLocation();
    get location() {
...
__decorate([
    nameForSerialization$1('dataTypePatterns')
], CustomBarcode.prototype, "_dataTypePatterns", void 0);
__decorate([
    nameForSerialization$1('location')
], CustomBarcode.prototype, "_location", void 0);
...
__decorate([
    nameForSerialization$1('location')
], CustomText.prototype, "_location", void 0);
